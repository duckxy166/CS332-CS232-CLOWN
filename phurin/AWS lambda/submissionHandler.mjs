...
const SCREENSHOT_BUCKET = process.env.SCREENSHOT_BUCKET || "lab-checker-screenshots-65401";
const QUEUE_URL = process.env.QUEUE_URL || "https://sqs.us-east-1.amazonaws.com/483018956721/lab-checker-queue";
